...
const products = [
    ...
    },
    {
        ...
        text: '【チーム開発】ハッカソン[BIPROGY DX HACK]で開発したプロダクトです。twilioを利用してビデオ通話アプリケーションの基盤を作成し、そこにリアルタイム音声認識を利用した「英語禁止ゲーム」を搭載しました。また、kintoneとHerokeから作成したAPIにより、簡単なアンケートを作成/実施/貯蔵できます。チームメンバーに恵まれたこと、常に最悪のケースを想定しながら開発したことが功をなし、前代未聞の3冠「最優秀賞、オーディエンス賞、kintone賞」を受賞しました。',
