        ...
        <Toolbar disableGutters>
            ...
            >
              {pages.map((page) => (
                <MenuItem key={page} onClick={handleCloseNavMenu}>
                  <Typography textAlign="center"><PfA href={`#${page}`} disable_decoration={true} text={page} /></Typography>
                </MenuItem>
              ))}
            </Menu>
          </Box>
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            {pages.map((page) => (
              ...
              >
                <PfA href={`#${page}`} disable_decoration={true} text={page}></PfA>
              </Button>
            ))}
          </Box>
          ...
          <Box sx={{ flexGrow: 0 }}>
            <Tooltip title="Open settings">
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                <Avatar alt="Hasegawa Masaki" src="/images/myImg.png" />
              </IconButton>
            </Tooltip>
            <Menu
              sx={{ mt: '45px' }}
