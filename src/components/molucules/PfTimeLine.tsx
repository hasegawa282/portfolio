    ...
    <Timeline position={matches?'alternate':'right'} style={{width: '100%'}}>
      ...
      <PfTimelineItem 
        paperProps={{
          ...
          text: '人生初のハッカソンに参加しました。テックリードとして、チームに開発環境を共有し、最終的に「リアルタイム音声認識による英語禁止ゲーム」と「アンケート機能」を搭載させたビデオ通話アプリケーションを開発しました。チームメンバーに恵まれたおかげで、前代未聞の3冠【最優秀賞、オーディエンス賞、kintone賞】を受賞できました。'
        }}
        icon={<Keyboard/>}
        date="2022/5"
      />
